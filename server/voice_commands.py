...
RULES: list[dict] = [
    ...
    {"group": "keys", "label": "⇤ shift-tab", "kind": "key", "key": "BTab",
     "triggers": ["shift tab", "shift-tab", "back tab", "backtab", "tab indietro"]},
    ...
    {"group": "keys", "label": "⌦ delete", "kind": "key", "key": "DC",
     "triggers": ["forward delete", "delete forward", "delete key", "del key", "canc"]},
    # Arrow keys — navigate Claude's menus (AskUserQuestion) and the prompt history.
    # "arrow <dir>" only (bare "up"/"down"/"left"/"right" would shadow the words).
    ...
    {"group": "keys", "label": "←", "kind": "key", "key": "Left",
     "triggers": ["arrow left", "left arrow", "freccia sinistra"]},
    {"group": "keys", "label": "→", "kind": "key", "key": "Right",
     "triggers": ["arrow right", "right arrow", "freccia destra"]},
    {"group": "keys", "label": "↖ home", "kind": "key", "key": "Home",
     "triggers": ["home", "line start", "start of line", "inizio riga"]},
    {"group": "keys", "label": "↘ end", "kind": "key", "key": "End",
     "triggers": ["line end", "end of line", "end key", "fine riga"]},
    {"group": "keys", "label": "⇞ page up", "kind": "key", "key": "PPage",
     "triggers": ["page up", "pageup", "pagina su"]},
    {"group": "keys", "label": "⇟ page down", "kind": "key", "key": "NPage",
     "triggers": ["page down", "pagedown", "pagina giù"]},
    ...
    {"group": "markdown", "label": "## heading", "kind": "prefix", "text": "## ",
     "triggers": ["heading two", "heading 2", "subheading", "sub heading", "sottotitolo"]},
    {"group": "markdown", "label": "### heading", "kind": "prefix", "text": "### ",
     "triggers": ["heading three", "heading 3", "sub subheading"]},
